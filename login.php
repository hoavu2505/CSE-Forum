                ...
                <div class="col-sm">
                    <div class="card text-white bg-outline-secondary mb-3 d-inline-block">
                        <form action="login.php" method="post">
                            ...
                            <div class="card-header"><h2 class="text-center">Đăng nhập</h2></div>
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" value="<?php echo $password; ?>" class="form-control" id="formGroupExampleInput2" placeholder="Nhập mật khẩu">
                                    </div>
                                </form>
                                <br>
                                <div class="text-center">
                                    <button type="submit" name="login-btn" class="btn btn-dark">Đăng nhập</button>
                                    &emsp;
